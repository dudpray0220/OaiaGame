...
public class HomeController {
	...
	public String createTable(HttpServletRequest request, Locale locale, Model model) throws SQLException {
	...
	public String adminAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
	...
	public String loginAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String admininfo(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		HttpSession session = request.getSession();
	...
	public String adminupdat(HttpServletRequest request, Locale locale, Model model,
			...
			@RequestParam("admin_name") String admin_name) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String selectuser(Locale locale, Model model) throws SQLException {
	...
	public String insertData(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String login(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String pwdConfirm(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String myinfo(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String update(HttpServletRequest request, Locale locale, Model model, @RequestParam("idx") int idx,
			...
			@RequestParam("user_email") String user_email, @RequestParam("user_nickName") String user_nickName) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
...
//	}
	...
	// 자유게시판
	@RequestMapping(value = "/boardList", method = RequestMethod.GET)
	public String selectData(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String selectBoardPageData(HttpServletRequest request, Locale locale, Model model,
			@RequestParam("pageIdx") int pageIdx) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String boardinsertAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String boardDetail(HttpServletRequest request, Locale locale, Model model,
			@RequestParam("idx") int contentsIdx) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String boardCommentsAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String deleteComments(HttpServletRequest request, Locale locale, Model model, @RequestParam("idx") int idx,
			@RequestParam("board_idx") int board_idx) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String u(HttpServletRequest request, Locale locale, Model model, @RequestParam("idx") int contentsIdx,
			@RequestParam("user_id") String user_id) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String updatePwdConfirm(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String boardupdateAction(HttpServletRequest request, Locale locale, Model model,
			...
			@RequestParam("user_id") String user_id, @RequestParam("user_content") String user_content) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String deletecontents(HttpServletRequest request, Locale locale, Model model,
			@RequestParam("idx") int contentsIdx, @RequestParam("user_id") String user_id) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String contentPwdConfirm(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
...
//		user_pwd = db.sha256(user_pwd);
	...
	public String userquestionList(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String answeryes(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String answerno(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String questioninsertAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public String questionupdateAction(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		try {
			request.setCharacterEncoding("UTF-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
...
//			return "questionUpdate?idx="+idx;
	...
	public String ranking(HttpServletRequest request, Locale locale, Model model) throws SQLException {
	...
	public String admin_game(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		HttpSession session = request.getSession();
	...
	public String user_game(HttpServletRequest request, Locale locale, Model model) throws SQLException {
		HttpSession session = request.getSession();
	...
	// 비회원용 게임-space ver (score 저장 X)
		...
		public String admin_game_space(HttpServletRequest request, Locale locale, Model model) throws SQLException {
			HttpSession session = request.getSession();
			String adminId = (String) session.getAttribute("login_id");
			AdminDB db = new AdminDB();
			String isSuccess = db.adminScore(adminId);
		...
		public String user_game_space(HttpServletRequest request, Locale locale, Model model) throws SQLException {
			HttpSession session = request.getSession();
			String userId = (String) session.getAttribute("login_id");
			UserDB db = new UserDB();
			String isSuccess = db.userScore(userId);
