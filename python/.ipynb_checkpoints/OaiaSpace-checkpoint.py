...
pygame.display.set_caption("OaiaSpace") # 창 타이틀
...
bg = pygame.image.load("C:/Users/Owner/Desktop/MyFirstProjectGame/img/bgSpaceResize.png") # 배경
# groung_img = pygame.image.load("C:/Users/SMART-14/Desktop/team7Project/MyFirstProjectGame/img/ground.png") # 땅 
button_img = pygame.image.load('C:/Users/Owner/Desktop/MyFirstProjectGame/img/restart.png') # 다시하기 버튼
...
class Bird(pygame.sprite.Sprite): # pygame의 sprite 클래스 이용 (update & draw)
    def __init__(self, x, y):
        ...
        for num in range(1, 4):
            img = pygame.image.load(f'C:/Users/Owner/Desktop/MyFirstProjectGame/img/spaceShip{num}.png')
    ...
    def update(self):
        ...
        if flying == True: # 게임 시작된 후 로직 구현
            ...
            if self.vel > 8:
                self.vel = 8
            if self.rect.bottom < 938: # 땅 속으로 들어가지 않도록
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load('C:/Users/Owner/Desktop/MyFirstProjectGame/img/pipe.png')
        self.rect = self.image.get_rect()
...
#     screen.blit(groung_img, (ground_scroll, 768))
    ...
    if flappy.rect.bottom >= 938: # hit the ground
        game_over = True
        flying = False
    ...
    if game_over == False and flying == True:
        ...
        if time_now - last_pipe > pipe_frequency:
            pipe_height = random.randint(-150, 150) # 랜덤 Number 생성
